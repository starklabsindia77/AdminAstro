...
export const PATH_DASHBOARD = {
  ...
  expert: {
    ...
    new: path(ROOTS_DASHBOARD, '/expert/new'),
    list: path(ROOTS_DASHBOARD, '/expert/list'),
    cards: path(ROOTS_DASHBOARD, '/expert/cards'),
    profile: path(ROOTS_DASHBOARD, '/expert/profile'),
    account: path(ROOTS_DASHBOARD, '/expert/account'),
    edit: (name) => path(ROOTS_DASHBOARD, `/expert/${name}/edit`),
    demoEdit: path(ROOTS_DASHBOARD, `/expert/reece-chung/edit`),
  },
  sessions: {
  ...
  blog: {
    ...
    edit: (title) => path(ROOTS_DASHBOARD, `/blog/post/${title}/edit`),
