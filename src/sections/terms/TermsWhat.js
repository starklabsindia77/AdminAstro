...
const TERMS_AND_CONDITIONS = [
  ...
  },
  {
    ...
    text: `The Website is providing certain service which is available through the medium of telecommunication with the Astrologer listed and enrolled with the Website. By agreeing to the present Terms of Usage, you are also giving your unconditional consent to the Website to arrange a call with you on your mobile number even though your number is on DND service provided by your mobile service provider.`,
  },
  {
    title: 'WEBSITE CONTENT',
    text: `The Website and any individual Websites which may be available through external hyperlinks with the Website are private property.
  ...
  },
  {
    ...
    text: `The Website shall have access to the account and the information created by the User for ensuring and maintaining the high-quality services provided by the Website and for addressing the need of the customer in the most effective manner. User hereby consents for the unconditional access of the account by the Website, its employees, agents and other appointed person in such regard. For the purpose of addressing the complaints (if any received) and any suspected abuse reported, the Website shall investigate on case-to-case basis from the records available. The User is directed to read the terms provided in the Privacy Policy as regards such records.`
  },
...
//     By requesting for refund, user is agreeing to provide Astro Score’s quality audit team permission to access the chat/call recording of the consultation for which refund has been requested, in order to determine whether the case is eligible for refund or not.
    
//     Astro Score quality audit team, at best effort basis, provide partial/full refunds to the users in their Astro Score wallet wherever consultant’s quality parameters are not satisfied. It can take upto 72 hours to analyse and refund the amount back to Astro Score wallet
    
//     Note: All refunds will be credited to user’s Astro Score wallet.
...
//         Please Note: No refund will be given in case of lack of accuracy of any consultation. Astro Score takes no responsibility for factual accuracy on any consultations.`
//   },
...
//   },
  ...
  //   Notwithstanding anything to the contrary contained herein, Astro Score liability to you for any cause whatsoever, and regardless of the form of the action, will at all times be limited to the amount paid, if any, by you to the Website, for the service during the term of membership.`
  // },
  ...
  //   In addition, all content such as images, text, designs, etc. on all of the portals of the Website have been sourced from various online portals such as Google Images. Astro Score Pvt Ltd. is not liable for any copyright claims pertaining to this content or data. Users should note that the copyrights of these contents belong to their respective owners and Astro Score Pvt Ltd. does not claim any ownership rights over such content. The use of these materials is intended for informational or educational purposes and does not constitute a claim of ownership.`
  // },
